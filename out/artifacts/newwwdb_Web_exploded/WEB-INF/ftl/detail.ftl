...
<head>
    <meta charset="UTF-8">
    <title>${persondata.personName}</title>
...
<#--            </#if>-->
            ...
            $("#btnSubmit").click(function(){
                ...
                $.post("/evaluate" , {
                    score : score,
                    persondataId : ${persondata.persondataId},
            ...
            $("*[data-evaluation-id]").click(function(){
                ...
                var evaluationId2 = (""+evaluationId).replace(",","");
                $.post("/enjoy",{evaluationId:evaluationId2},function(json){
                    if(json.code == "0"){
...
<div class="container ">
    <nav class="navbar navbar-light bg-white shadow mr-auto">
        <ul class="nav">
            <li class="nav-item">
                <a href="/">
                    <img src="/images/shangbiao.png"  class="mt-1"
                         style="width: 100px">
                </a>
            </li>
    ...
    <div class="container mt-2 p-2 m-0" style="background-color:rgb(127, 125, 121)">
        <div class="row">
            ...
            <div class="col-8 pt-2 mb-2 pl-0">
                <h6 class="text-white">玩家名:${persondata.personName}</h6>
                <div class="p-1 alert alert-warning small" role="alert">
                    简介:${persondata.subTitle}
                </div>
                <p class="mb-1">
                    <span class="text-white-50 small">作者:${persondata.author}</span>
                </p>
...
<#--            <div class="col-2"><h2 class="text-white">${persondata.evaluationScore}</h2></div>-->
<#--            <div class="col-5 pt-2">-->
<#--                <span class="stars" data-score="${persondata.evaluationScore}"></span>-->
<#--            </div>-->
<#--            <div class="col-5  pt-2"><h5 class="text-white">${persondata.evaluationQuantity}人已评</h5></div>-->
<#--        </div>-->
    </div>
    ...
    <div class="alert alert-primary w-100 mt-2" role="alert">玩家数据
    ...
    <div class="reply pl-2 pr-2">
        ...
        <div>
            <div>
                ...
                <span class="mr-2 small pt-1">${evaluation.wolfuser.username}</span>
...
<div class="modal fade" id="dlgEvaluation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <h6>为"${persondata.personName}"写玩家数据</h6>
                <form id="frmEvaluation">
                    <div class="input-group  mt-2 ">
                        <span id="score"></span>
                    </div>
                    <div class="input-group  mt-2 ">
                        <input type="text" id="content" name="content" class="form-control p-4" placeholder="这里输入玩家数据">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
