...
<div>注意:注册之后只能用该用户名创建个人资料!!!请使用能辨别的名字</div>
    <div>tips:如果你想偷偷评论可以注册个小号</div>
    <div class="container mt-2 p-2 m-0">
        <form id="frmLogin">
            <div class="passport bg-white">
                <h4 class="float-left">注册</h4>
                <h6 class="float-right pt-2"><a href="/login.html">登录</a></h6>
                ...
                <div class="input-group  mt-4 ">
                    <input type="text" id="wechatId" name="wechatId" class="form-control p-4" placeholder="请输入微信号"
                    >
                </div>
<#--                <div class="input-group mt-4 ">-->
<#--                    <div class="col-5 p-0">-->
...
<script>
    ...
    //     //请在这里实现刷新验证码
    //     //增加时间戳以防验证码图片被缓存不更新图片，attr代表设置组件的属性
